...
[ -f "${UPDATES_DIR}/${plugin_name}-${stable_tag}.zip" ] && rm -f "${UPDATES_DIR}/${plugin_name}-${stable_tag}.zip"
  ...
  EXCLUDES=(
    ...
    "--exclude=**/.npm"
    "--exclude=**/.tanstack"
    "--exclude=/lib/vendor/donatj/phpuseragentparser/tests"
    "--exclude=/lib/vendor/donatj/phpuseragentparser/bin"
    "--exclude=/lib/vendor/donatj/phpuseragentparser/examples"
    "--exclude=/lib/vendor/donatj/phpuseragentparser/Makefile"
    "--exclude=/lib/vendor/geoip2/geoip2/src/WebService"
    "--exclude=/lib/vendor/maxmind/"
    "--exclude=/lib/vendor/maxmind-db/reader/ext"
    "--exclude=/lib/vendor/maxmind-db/reader/package.xml"
    "--exclude=/lib/vendor/bin/"
    "--exclude=CLAUDE.md"
    "--exclude=*.md"
  )
