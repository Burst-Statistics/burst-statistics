...
if ( ! class_exists( 'Geo_Ip' ) ) {
	class Geo_Ip {
		...
		private $db_url = 'https://burst.ams3.cdn.digitaloceanspaces.com/maxmind/GeoLite2-Country.tar.gz';
		/**
		 * Constructor
		 */
		...
		public function initialize(): void {
			...
			if ( $this->has_admin_access() && get_option( 'burst_geo_ip_import_error' ) ) {
